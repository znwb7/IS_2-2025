...
public class DataBase {
        ...
        public String getHashByID(String ID) {
            ...
            try (BufferedReader br = new BufferedReader(new FileReader(rutaArchivo))) {
                ...
                while ((line = br.readLine()) != null) {
                    ...
                    if (Word[1].equals(ID)) {
                        return Word[4]; // posición del HASH
                    }
                }
    ...
    //SECCION DE ACTUALIZACION DEL SALDO DEL USUARIO
        ...
        //SUBSTRAE EL SALDO DEL USUARIO EN LA BD PRINCIPAL
    ...
    try {
        ...
        try (BufferedReader brMenu = new BufferedReader(new FileReader(fileMenu))) {
            ...
            while ((line = brMenu.readLine()) != null) {
                ...
                if (wordMenu.length > 7 &&
                        wordMenu[0].trim().equals(fechaActual) &&
                        wordMenu[1].trim().equalsIgnoreCase(tipo)) {

                    switch (rol) {

                        case ESTUDIANTE:
                            montoAPagar = wordMenu[5].trim();
                            break;

                        case PROFESOR:
                            montoAPagar = wordMenu[6].trim();
                            break;
        ...
        try (BufferedReader brPrincipal = new BufferedReader(new FileReader(filePrincipal))) {
            ...
            while ((linea = brPrincipal.readLine()) != null) {
                ...
                if (wordsP.length < 11) {
                    wordsP = java.util.Arrays.copyOf(wordsP, 11);
                }

                if (wordsP[1].trim().equals(id)) {
